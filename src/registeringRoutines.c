...
*/
  ...
  /* .Call calls */
  extern SEXP _icenRegDev_computeConditional_p(SEXP, SEXP, SEXP, SEXP, SEXP);
extern SEXP _icenRegDev_computeConditional_q(SEXP, SEXP, SEXP, SEXP, SEXP);
extern SEXP _icenRegDev_ic_parList(SEXP);
extern SEXP _icenRegDev_R_ic_bayes(SEXP, SEXP, SEXP);
...
static const R_CallMethodDef CallEntries[] = {
  {"_icenRegDev_computeConditional_p", (DL_FUNC) &_icenRegDev_computeConditional_p,  5},
  {"_icenRegDev_computeConditional_q", (DL_FUNC) &_icenRegDev_computeConditional_q,  5},
  {"_icenRegDev_ic_parList",           (DL_FUNC) &_icenRegDev_ic_parList,            1},
  {"_icenRegDev_R_ic_bayes",           (DL_FUNC) &_icenRegDev_R_ic_bayes,            3},
...
void R_init_icenRegDev(DllInfo *dll)
{
